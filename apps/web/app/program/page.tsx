...
export default async function ProgramsPage() {
  ...
  const programs = [
    { href: "/program/incubation", number: "01", icon: Rocket, title: copy.nav.incubation, subtitle: copy.pages.programs.subtitles[0], text: copy.home.programTexts[0], facts: [copy.common.free, `12 ${copy.common.weeks}`, "0% equity"], className: "incubation" },
    { href: "/program/acceleration", number: "02", icon: BrainCircuit, title: copy.nav.acceleration, subtitle: copy.pages.programs.subtitles[1], text: copy.home.programTexts[1], facts: ["Weekly targets", `10 ${copy.common.weeks}`, "Demo Day"], className: "acceleration" },
    { href: "/program/it-education", number: "03", icon: Code2, title: copy.nav.education, subtitle: copy.pages.programs.subtitles[2], text: copy.home.programTexts[2], facts: [copy.common.free, "IT", "Practice"], className: "education" },
  ];
